import{i as h,O as u,x as s,e as m,a as k,r as i,d as p,b as v}from"./state-BPDrD376.js";var b=Object.defineProperty,l=(c,o,t,r)=>{for(var e=void 0,a=c.length-1,g;a>=0;a--)(g=c[a])&&(e=g(o,t,e)||e);return e&&b(o,t,e),e};const d=class d extends h{constructor(){super(...arguments),this._authObserver=new u(this,"melonbowl:auth"),this.loggedIn=!1,this.isDarkMode=!1,this.handleExternalDarkModeChange=o=>{const t=o;this.isDarkMode=t.detail.checked}}connectedCallback(){super.connectedCallback(),this._authObserver.observe(r=>{const{user:e}=r;e&&e.authenticated?(this.loggedIn=!0,this.userid=e.username):(this.loggedIn=!1,this.userid=void 0)});const o=localStorage.getItem("dark-mode"),t=window.matchMedia("(prefers-color-scheme: dark)").matches;this.isDarkMode=o==="true"||o===null&&t,document.body.classList.toggle("dark-mode",this.isDarkMode),document.body.addEventListener("dark-mode:toggle",this.handleExternalDarkModeChange)}disconnectedCallback(){super.disconnectedCallback(),document.body.removeEventListener("dark-mode:toggle",this.handleExternalDarkModeChange)}handleDarkModeToggle(o){const r=o.target.checked;this.isDarkMode=r,localStorage.setItem("dark-mode",String(r)),document.body.classList.toggle("dark-mode",r);const e=new CustomEvent("dark-mode:toggle",{bubbles:!0,composed:!0,detail:{checked:r}});this.dispatchEvent(e)}render(){return s`
  ...
  `;let n=d;l([i()],n.prototype,"loggedIn");l([i()],n.prototype,"userid");l([i()],n.prototype,"isDarkMode");p({"melon-header":n,"mu-auth":v.Provider});
