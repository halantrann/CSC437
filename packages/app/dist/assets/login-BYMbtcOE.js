import{i as u,x as l,b as m,r as p,n as c,d as f,a as b}from"./state-xO4YFB9X.js";import{r as g}from"./reset.css-CC36bD5I.js";var v=Object.defineProperty,i=(d,e,t,s)=>{for(var r=void 0,a=d.length-1,h;a>=0;a--)(h=d[a])&&(r=h(e,t,r)||r);return r&&v(e,t,r),r};const n=class n extends u{constructor(){super(...arguments),this.formData={},this.redirect="/"}get canSubmit(){return!!(this.api&&this.formData.username&&this.formData.password)}render(){return l`
      <form
    ...
    `];let o=n;i([p()],o.prototype,"formData");i([c()],o.prototype,"api");i([c()],o.prototype,"redirect");i([p()],o.prototype,"error");f({"mu-auth":b.Provider,"login-form":o});
